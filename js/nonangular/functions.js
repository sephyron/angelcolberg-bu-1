...
(function($) {
    ...
    angelPortfolio.initialize = {
        ...
        init: function() {
            angelPortfolio.initialize.newSlider();
        ...
        loadItem: function(portPostId, prevPostPortId, getIt) {
            ...
            if (getIt == false) {
                ...
                $portfolioDetailsContainer.load(portfolioDataLoader, { portid: portPostId, portnext: portNext, portprev: portPrev },
                    function() {
                        angelPortfolio.portfolio.initializeAjax(portPostId);
    ...
    angelPortfolio.widget = {
        ...
        init: function() {
            ...
            angelPortfolio.widget.instagramPhotos('36286274.b9e559e.4824cbc1d0c94c23827dc4a2267a9f6b', 'b9e559ec7c284375bf41e9a9fb72ae01');
            angelPortfolio.widget.dribbbleShots('01530280af335d298e756ed8ef786c8c4e92a50b88e53a185531b1a639e768b8');
        ...
        loadFlexSlider: function() {
            ...
            if ($flexSliderEl.length > 0) {
                $flexSliderEl.each(function() {
                    ...
                    if (flexsSheight == 'true') { flexsSheight = true; } else { flexsSheight = false; }
                    if (flexsDirection == 'vertical') { flexsSheight = false; }
                    if (flexsPagi == 'false') { flexsPagi = false; } else { flexsPagi = true; }
                    if (flexsThumbs == 'true') { flexsPagi = 'thumbnails'; } else { flexsPagi = flexsPagi; }
                    if (flexsArrows == 'false') { flexsArrows = false; } else { flexsArrows = true; }
                    if (flexsHover == 'true') { flexsHover = true; } else { flexsHover = false; }
                    ...
                    $flexsSlider.flexslider({
                        ...
                        start: function(slider) {
                            ...
                            function grabContent(curr) {
                                var tn = curr.data('thumbnail');
                                var alt = curr.prop('alt');
                                var html = '';
