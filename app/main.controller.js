...
(function() {
    ...
    MainController.$inject = ['LocalStorage', 'QueryService', '$rootScope', '$routeParams'];


    function MainController(LocalStorage, QueryService, $rootScope, $routeParams) {

        // 'controller as' syntax
        var self = this;
        var $ = jQuery.noConflict();
        // ng-view nganimate page transition
        $rootScope.cssClass = 'view1';
        //$rootScope.path = '/' + $routeParams;
        //Current year
        ...
        // Gradient Background on Sine Waves
        ...
        var angelPortfolio = angelPortfolio || {};
        ...
        (function($) {
            ...
            angelPortfolio.initialize = {
                ...
                init: function() {
                    ...
                    angelPortfolio.initialize.imageFade();
                    angelPortfolio.initialize.pageTransition();
                ...
                useCase: function() {
                    ...
                    $(".use-case-trigger").on("click", function() {
                        $('.use-case').removeClass('hidden').alert("hello")
                    ...
                    if ($commonHeightEl.length > 0) {
                        ...
                        $commonHeightEl.each(function() {
                            ...
                            if (element.find('.common-height').length > 0) {
                                angelPortfolio.initialize.commonHeight(element.find('.common-height:not(.customjs)'));
                            }

                            angelPortfolio.initialize.commonHeight(element);
                        });
                    }
                },
                ...
                lightbox: function() {
                    ...
                    if ($lightboxAjaxEl.length > 0) {
                        $lightboxAjaxEl.magnificPopup({
                            type: 'ajax',
                            mainClass: 'mfp-no-margins mfp-angel',
                            closeBtnInside: true,
                            closeOnBgClick: false,
                            observer: true,
                            observeParents: true,
                            closeMarkup: '<button class="trigger-2 mfp-close page-close-button"><svg width="50" height="50" viewBox="0 0 60 60" preserveAspectRatio="none"><g class="icon--cross-page"><line x1="4.5" y1="55.5" x2="54.953" y2="5.046" /><line x1="54.953" y1="55.5" x2="4.5" y2="5.047" /></g></svg><span>Close</span></button>',
                            removalDelay: 1500,
                            callbacks: {
                ...
                lazyLoad: function() {
                    ...
                    if (lazyLoadEl.length > 0) {
                        lazyLoadEl.each(function() {
                            ...
                            element.attr('src', 'images/blank.svg').css({ 'background': 'url(./2017/images/preloader-dark.gif) no-repeat center center #FFF' });
                ...
                topScrollOffset: function() {
                    ...
                    if (($body.hasClass('device-lg') || $body.hasClass('device-md')) && !angelPortfolio.isMobile.any()) {
                ...
                setFullColumnWidth: function(element) {
                    ...
                    if (element.hasClass('portfolio-full')) {
                        var columns = angelPortfolio.initialize.defineColumns(element);
            ...
            angelPortfolio.header = {
                ...
                init: function() {
                    ...
                    angelPortfolio.header.superfish();
                    angelPortfolio.header.menufunctions();
                    angelPortfolio.header.fullWidthMenu();
                    angelPortfolio.header.overlayMenu();
                    angelPortfolio.header.stickyMenu();
                    angelPortfolio.header.stickyPageMenu();
                    angelPortfolio.header.sideHeader();
                    angelPortfolio.header.sidePanel();
                    angelPortfolio.header.onePageScroll();
                    angelPortfolio.header.onepageScroller();
                    angelPortfolio.header.logo();
                    angelPortfolio.header.topsearch();
                    angelPortfolio.header.topcart();
                ...
                superfish: function() {
                    ...
                    if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                        ...
                        angelPortfolio.header.menuInvert();
                    ...
                    $('body:not(.side-header) #primary-menu > ul, body:not(.side-header) #primary-menu > div > ul:not(.dropdown-menu), .top-links > ul').superfish({
                        ...
                        onShow: function() {
                            ...
                            if (megaMenuContent.find('.owl-carousel.customjs').length > 0) {
                                ...
                                angelPortfolio.widget.carousel();
                            }

                            if (megaMenuContent.hasClass('mega-menu-content') && megaMenuContent.find('.widget').length > 0) {
                                if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                                    setTimeout(function() { angelPortfolio.initialize.commonHeight(megaMenuContent); }, 200);
                                } else {
                ...
                menufunctions: function() {
                    ...
                    if (angelPortfolio.isMobile.Android()) {
                    ...
                    if (angelPortfolio.isMobile.Windows()) {
                        if ($().superfish) {
                ...
                stickyMenu: function(headerOffset) {
                    if ($window.scrollTop() > headerOffset) {
                        ...
                        angelPortfolio.header.removeStickyness();
                    }
                },
                    ...
                    if ($onePageMenuEl.length > 0) {
                        ...
                        $onePageMenuEl.find('a[data-href]').click(function() {
                            ...
                            if ($(divScrollToAnchor).length > 0) {
                                ...
                                if (!onePageOffset) {
                                    var onePageOffsetG = angelPortfolio.initialize.topScrollOffset();
                                } else {
                ...
                onepageScroller: function() {
                    $onePageMenuEl.find('li').removeClass('current');
                    $onePageMenuEl.find('a[data-href="#' + angelPortfolio.header.onePageCurrentSection() + '"]').parent('li').addClass('current');
                },
            ...
            angelPortfolio.slider = {
                ...
                init: function() {
                    ...
                    angelPortfolio.slider.sliderRun();
                    angelPortfolio.slider.sliderParallax();
                    angelPortfolio.slider.sliderElementsFade();
                ...
                sliderParallax: function() {
                    ...
                    var parallaxOffsetTop = angelPortfolio.slider.sliderParallaxOffset(),
                ...
                swiperSliderMenu: function(onWinLoad) {
                    ...
                    if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                        ...
                        angelPortfolio.slider.headerSchemeChanger(activeSlide, onWinLoad);
                    }
                },
                ...
                arrange: function() {
                    if ($portfolio.length > 0) {
                        $portfolio.each(function() {
                            var element = $(this);
                            angelPortfolio.initialize.setFullColumnWidth(element);
                        });
                    }
                },
                ...
                loadItem: function(portPostId, _prevPostPortId, getIt) {
                    ...
                    if (getIt == false) {
                        ...
                        $portfolioDetailsContainer.load(portfolioDataLoader /*, { portid: portPostId, portnext: portNext, portprev: portPrev }*/ ,
                            function() {
                                angelPortfolio.portfolio.initializeAjax();
                                angelPortfolio.portfolio.openItem();
                ...
                openItem: function() {
                    ...
                    if (noOfImages > 0) {
                        $portfolioDetails.find('img').on('load', function() {
                            noLoaded++;
                            var topOffsetScroll = angelPortfolio.initialize.topScrollOffset();
            ...
            angelPortfolio.widget = {
                ...
                init: function() {
                    ...
                    angelPortfolio.widget.tabsResponsive();
                    angelPortfolio.widget.tabsResponsiveResize();
                    angelPortfolio.widget.toggles();
                    angelPortfolio.widget.accordions();
                    angelPortfolio.widget.counter();
                    angelPortfolio.widget.roundedSkill();
                    angelPortfolio.widget.progress();
                    angelPortfolio.widget.twitterFeed();
                    angelPortfolio.widget.flickrFeed();
                    angelPortfolio.widget.instagramPhotos();
                    angelPortfolio.widget.dribbbleShots('9b55c667cb9fc832f03eeae1ea87ea0e2d8d76b22c6ee8817d33661265a7841f');
                    angelPortfolio.widget.navTree();
                    angelPortfolio.widget.textRotater();
                    angelPortfolio.widget.carousel();
                    angelPortfolio.widget.linkScroll();
                    angelPortfolio.widget.contactForm();
                    angelPortfolio.widget.subscription();
                    angelPortfolio.widget.quickContact();
                    angelPortfolio.widget.stickySidebar();
                    angelPortfolio.widget.cookieNotify();
                    angelPortfolio.widget.extras();
                ...
                html5Video: function() {
                    ...
                    if (videoEl.length > 0) {
                        videoEl.each(function() {
                            ...
                            if (angelPortfolio.isMobile.any() && !element.hasClass('no-placeholder')) {
                            ...
                            element.find('.acctitle').click(function() {
                                if ($(this).next().is(':hidden')) {
                                    ...
                                    $(this).toggleClass('acctitlec').next().slideDown("normal", function() {
                                        $('html,body').stop(true).animate({
                                            'scrollTop': clickTarget.offset().top - (angelPortfolio.initialize.topScrollOffset() - 40)
                                        }, 800, 'easeOutQuad');
                                    });
                                }
                                return false;
                ...
                counter: function() {
                    ...
                    if ($counterEl.length > 0) {
                        $counterEl.each(function() {
                            ...
                            if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                                element.appear(function() {
                                    angelPortfolio.widget.runCounter(element, counterElementComma);
                            ...
                            if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                                ...
                                element.appear(function() {
                                    if (!element.hasClass('skills-animated')) {
                                        ...
                                        angelPortfolio.widget.runRoundedSkills(element, properties);
                ...
                masonryThumbs: function() {
                    ...
                    if ($masonryThumbsEl.length > 0) {
                        $masonryThumbsEl.each(function() {
                            ...
                            angelPortfolio.widget.masonryThumbsArrange(masonryItemContainer);
                        });
                    }
                },
                ...
                linkScroll: function() {
                    $("a[data-scrollto]").click(function() {
                        ...
                        if (!divScrollOffset) { divScrollOffset = angelPortfolio.initialize.topScrollOffset(); }
                                ...
                                $(form).ajaxSubmit({
                                    ...
                                    success: function(data) {
                                        ...
                                        if (elementAlert == 'inline') {
                                            ...
                                            angelPortfolio.widget.notifications(elementResult);
                                        }
            ...
            angelPortfolio.documentOnReady = {
                ...
                init: function() {
                    ...
                    if ($slider.length > 0) { angelPortfolio.slider.init(); }
                    if ($portfolio.length > 0) { angelPortfolio.portfolio.init(); }
            ...
            angelPortfolio.documentOnLoad = {
                ...
                init: function() {
                    ...
                    angelPortfolio.initialize.stickyFooter();
                    angelPortfolio.portfolio.gridInit($gridContainer);
